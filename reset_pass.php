...
if (!$email) {
   ...
   $sel_query = "SELECT * FROM `webuser` WHERE email='".$email."'";
   $results = mysqli_query($database,$sel_query);
...
$mail->SMTPAuth = true;
$mail->Username = "phillipphilcourts540@gmail.com"; // Enter your email here
$mail->Password = "phillipphilcourts540@2001"; //Enter your password here
$mail->Port = 25;
$mail->IsHTML(true);
